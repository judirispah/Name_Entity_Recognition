...
from ner.entity.artifact_entity import (
    DataIngestionArtifacts,DataTransformationArtifacts,ModelTrainingArtifacts,ModelEvaluationArtifacts)
from ner.entity.config_entity import (
    DataIngestionConfig,DataTransformationConfig,ModelTrainingConfig,ModelEvalConfig)
    ...
    def start_data_ingestion(self) -> DataIngestionArtifacts:
        ...
        try:
            ...
            data_ingestion = DataIngestion(
                data_ingestion_config=self.data_ingestion_config, aws=self.aws
            )
            data_ingestion_artifact = data_ingestion.initiate_data_ingestion()
            logging.info("Got the data from aws cloud storage")
            logging.info(
